...
const ItemCard = ({item}) => {
    ...
    <div>
        ...
        :
        <div className='flex flex-col items-center justify-center w-full text-center border-2 shadow-2xl dark:shadow-slate-600 dark:shadow-md py-4 lg:text-left'>
        <div className='flex flex-col w-full items-end'>
            <div onClick={handleOpen}>{toggle ? <FontAwesomeIcon icon={faSortDown} className='px-4 text-2xl cursor-pointer dark:text-white'></FontAwesomeIcon> : <FontAwesomeIcon icon={faSortUp} className='px-4 text-2xl cursor-pointer dark:text-white'></FontAwesomeIcon>}</div>
        ...
        <div className='flex flex-col items-center justify-center space-y-4 px-4 py-4 lg:items-start'>
            <h3 className='font-roboto text-xl dark:text-white'>{item.title}</h3>
            <p className='font-sans text-sm dark:text-white'>{item.description}</p>
